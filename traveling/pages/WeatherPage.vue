...
export default {
  ...
  async changeLocation(){
      ...
      let URL= `https://pro.openweathermap.org/data/2.5/climate/month?q=${this.countrySelected}&appid=${token}&lang=${lang}&units=${unit}`

      let response= await this.$axios.get(URI)
      let mensual = await this.$axios.get(URL)
